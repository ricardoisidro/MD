//
//  HistPeriodicoPageViewController.swift
//  Maguen
//
...
class HistPeriodicoPageViewController: UIPageViewController, UIPageViewControllerDataSource, UIPageViewControllerDelegate  {
    ...
    var noPaginas: Int64?
    var idPublicacion: Int64?
    var titlePublicacion: String?
    ...
    override func viewDidLoad() {
        ...
        guard let noPag = noPaginas else
        {
            return
        }
        
        guard let idPub = idPublicacion else
        {
            return
        }
        guard let titPubli = titlePublicacion else
        {
            return
        }
        ...
        vctitle = titPubli
        for i in 1...noPag {
             let pagename = MaguenCredentials.urlMagazine + "\(String(idPub))/pagina\(String(i)).jpg"
...
class FrameViewController3: UIViewController, UIGestureRecognizerDelegate {
